	...
	<div class="row">
        ...
        <div class="span4 plan">
          ...
          <ul>
			...
			<div class="span12">
					<h1>
					Products Featurettes
					</h1>
					<div class="row">
					<div class="span3">
					  <h5><i class="icon icon-globe"></i> Description 1</h5>
					  <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.</p>
					</div>
			 
					<div class="span3">
					  <h5><i class="icon-ok"></i> Description 2</h5>
					  <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.</p>
					</div>
					<div class="span3">
					  <h5><i class="icon-bold"></i> Description 3</h5>
					  <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.</p>
					</div>
					<div class="span3">
					  <h5><i class="icon icon-star"></i> Description 4</h5>
					  <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.</p>
					</div>
				  </div>
				</div>
				...
				<div class="span3">
					<div class="well" style="padding: 8px 0;">
						<ul class="nav nav-list">
							...
							<li>
								<a href="projects"><i class="icon-folder-open"></i> Projects</a>
							</li>
							<li>
								<a href="tasks"><i class="icon-check"></i> Tasks</a>
							</li>
							<li>
								<a href="messages"><i class="icon-envelope"></i> Messages</a>
							</li>
							<li>
								<a href="files"><i class="icon-file"></i> Files</a>
							</li>
							<li>
								<a href="activity"><i class="icon-list-alt"></i> Activity</a>
							</li>
							<li class="nav-header">
								Your Account
							</li>
							...
							<li>
								<a href="gallery"><i class="icon-picture"></i> Gallery</a>
							</li>
							<li class="active">
								<a href="blank"><i class="icon-stop icon-white"></i> Blank Slate</a>
							</li>
						</ul>
					</div>
				</div>
